...
export default function EditorPanel({ markdownInput, onInputChange, editorScrollRef, onEditorScroll, scrollSyncEnabled, onSelectAll, onClearRequest, immersive }: EditorPanelProps) {
